...
Penjual.prototype.greeting = () => {
    console.log('Selamat datang di toko kami!'); 
}

// Tapi apabila kita sudah menambahkan property lain, maka yang diutamakan/dicek pertama kali itu property yang ada di inheritance, sedangkan property yang ada di prototype belakangan 
jual.greeting = 'Selamat datang di toko kami!';
